...
from sense.grounding import GroundingResult, GroundingSource  # Local import
from sense.utils.security import RestrictedPython  # Assuming existing security utils if available
