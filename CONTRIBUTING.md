...
1. **Fork the Repository**: 
   - Fork the [SENSE repository](https://github.com/taeddings/SENSE) on GitHub.
...
3. **Develop and Test Your Contribution**: 
   ...
   - **Module Structure**: New intelligence features should go in `src/sense/intelligence/`. Core reasoning logic resides in `src/sense/core/`.
   - Ensure your code adheres to the existing style (Caveman Parsing, Absolute Paths).
   - Test your changes thoroughly using `python run_tests.py` or `verify_intelligence.py`.
...
## Guidelines
- **Follow the 8 Immutable Laws**: See `ARCH.md` or `CHANGELOG.md` for the core architectural rules.
- **Write Clear Commit Messages**: Your commit messages should explain what changes were made and why.
- **Update Documentation**: If your changes require it, update `README.md` or `ARCH.md`.
